package com.ada.rabbitmq.amqp.basic.config;
...
public class RabbitConfig {
    ...
    public TopicExchange getTopicExchange(){
        return new TopicExchange("Ada_BASIC_TOPIC_EXCHANGE");
    }

    @Bean("fanoutExchange")
    public FanoutExchange getFanoutExchange(){
        return  new FanoutExchange("Ada_BASIC_FANOUT_EXCHANGE");
    }
    ...
    public Queue getFirstQueue(){
        ...
        Queue queue = new Queue("Ada_BASIC_FIRST_QUEUE", false, false, true, args);
        return queue;
    }

    @Bean("secondQueue")
    public Queue getSecondQueue(){
        return new Queue("Ada_BASIC_SECOND_QUEUE");
    }

    @Bean("thirdQueue")
    public Queue getThirdQueue(){
        return new Queue("Ada_BASIC_THIRD_QUEUE");
    }
