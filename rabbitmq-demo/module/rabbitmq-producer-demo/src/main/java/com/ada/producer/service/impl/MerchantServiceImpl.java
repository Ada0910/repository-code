package com.ada.producer.service.impl;


import com.ada.producer.entity.Merchant;
import com.ada.producer.mapper.MerchantMapper;
import com.ada.producer.service.MerchantService;
...
public class MerchantServiceImpl implements MerchantService {
    ...
    public int add(Merchant merchant) {
        ...
        adaTemplate.convertAndSend(topicExchange,topicRoutingKey, title.toJSONString());
