package com.ada.consumer.entity;
...
public class Merchant implements Serializable {
	...
	public String toString() {
		return "Merchant{" + "id=" + id + ", name='" + name + '\'' + ", address='" + address + '\'' + ", accountNo='" + accountNo + '\'' + ", accountName='" + accountName + '\'' + ", state='" + state + '\'' + ", stateStr='" + stateStr + '\'' + '}';
	}
}
