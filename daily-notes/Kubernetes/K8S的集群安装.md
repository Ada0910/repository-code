...
> `官网`：[https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#installing-kubeadm-kubelet-and-kubectl](https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#installing-kubeadm-kubelet-and-kubectl)
> 
...
> (2)初始化master节点
> 
> 官网：[https://kubernetes.io/docs/reference/setup-tools/kubeadm/kubeadm/](https://kubernetes.io/docs/reference/setup-tools/kubeadm/kubeadm/)
> 
> `注意`：**此操作是在主节点上进行**
...
```
kubeadm join 192.168.1.101:6443 --token xy4ay5.bpx1q4rkox4jbn4n \
    --discovery-token-ca-cert-hash sha256:98a639ed01ab6615063cca2c20093e1e1fc3951979f217e82a0ad3ace70879e5 
...
> `官网`：[https://kubernetes.io/docs/reference/](https://kubernetes.io/docs/reference/)
...
> `官网`：[https://kubernetes.io/docs/concepts/containers/](https://kubernetes.io/docs/concepts/containers/)
...
> `官网`：[https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/)
